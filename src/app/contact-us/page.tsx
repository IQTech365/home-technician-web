...
const ContactUs = () => {
    ...
    return (
<div>
      <Image src={bannerImage} alt="image" className="w-full " />
      <h2 className="text-center text-2xl font-semibold my-3">Contact Us</h2>
      <div className=" flex flex-wrap md:px-24 justify-center">
        <div className="w-full md:w-1/2 p-8">
          <h3 className="text-center text-lg font-bold my-3 text-[#101828]">
            Get in Touch
          </h3>
        ...
        <div className="w-full md:w-1/2 p-8 gap-2">
          ...
          <div className="rounded-lg shadow-md p-4 mt-1">
            ...
            <p className="mb-2 text-[#101828]">
              ...
              <a href="tel:73033 87506">+91 73033 87506</a>
            </p>
            <p className="mb-2 text-[#101828]">
              <strong>Email</strong> : hometechnician@gmail.com
            </p>
            <p className="mb-2 text-[#101828]">
